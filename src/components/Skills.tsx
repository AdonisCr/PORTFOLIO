      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className={`text-5xl font-bold mb-6 ${
            ...
            Mes <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">Compétences</span>
          </h2>
          
          <p className={`text-lg max-w-2xl mx-auto ${
            isDarkMode ? 'text-gray-400' : 'text-gray-600'
          }`}>
            Un arsenal technologique complet pour donner vie à vos projets les plus ambitieux
          </p>
        </div>
          ...
          {skillCategories.map((category, categoryIndex) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 ${category.bgColor} blur-xl`}></div>
                      ...
                      >
                        ...
                        <div className={`relative w-full rounded-full h-2.5 overflow-hidden ${
                          ...
                          <div 
                            ...
                            style={{ 
                              width: hoveredSkill === `${categoryIndex}-${skillIndex}` ? '100%' : `${skill.level}%`,
                              opacity: hoveredSkill === `${categoryIndex}-${skillIndex}` ? 0.5 : 1
                            }}
                          >
                            {/* Effet de brillance */}
        ...
        <div className={`mt-16 p-8 rounded-2xl border ${
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <div className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Niveau moyen</div>
            </div>
            <div className="text-center">
              <div className={`text-4xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2`}>
                4
              </div>
              <div className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Catégories</div>
            </div>
            <div className="text-center">
              <div className={`text-4xl font-bold bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent mb-2`}>
                5+
              </div>
              <div className={`text-sm ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>Ans d'expérience</div>
            </div>
          </div>
        </div>
      </div>
