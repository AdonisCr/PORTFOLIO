...
const Projects = () => {
  ...
  const categories = [
    ...
    { id: "website", name: "Sites Web", icon: Globe },
  ];

  const projects = [
    {
      title: "Link-o",
      description: "Application web minimaliste pour raccourcir, gérer et suivre vos liens efficacement.",
      image: "https://images.pexels.com/photos/230544/pexels-photo-230544.jpeg?auto=compress&cs=tinysrgb&w=800",
      technologies: ["JavaScript", "Vercel", "API"],
      category: "web",
      demoUrl: "https://link-o-five.vercel.app",
      githubUrl: "https://github.com/AdonisCr/Link-o",
    },
    {
      title: "TimePro",
      description: "Application de gestion de temps moderne et intuitive.",
      image: "https://images.pexels.com/photos/1181677/pexels-photo-1181677.jpeg?auto=compress&cs=tinysrgb&w=800",
      technologies: ["TypeScript", "React", "Vercel"],
      category: "web",
      demoUrl: "https://time-pro-ten.vercel.app",
      githubUrl: "https://github.com/AdonisCr/TimePro",
    },
    {
      title: "APP-GSTOCK-vue",
      description: "Application de gestion de stocks développée avec Vue.js.",
      ...
      category: "web",
      demoUrl: "#",
      githubUrl: "https://github.com/AdonisCr/APP-GSTOCK-vue",
    },
    {
      title: "Portfolio",
      description: "Mon portfolio personnel développé avec React, TypeScript et Framer Motion.",
      image: "https://images.pexels.com/photos/1581384/pexels-photo-1581384.jpeg?auto=compress&cs=tinysrgb&w=800",
      technologies: ["React", "TypeScript", "Framer Motion", "Tailwind"],
      category: "website",
      demoUrl: "https://portfolio-umber-one-18.vercel.app",
      githubUrl: "https://github.com/AdonisCr/PORTFOLIO",
    },
    {
      title: "Docker-Exam",
      description: "Examen de fin de module Docker — conteneurisation et déploiement.",
      image: "https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=800",
      technologies: ["Docker", "JavaScript"],
      category: "web",
      demoUrl: "#",
      githubUrl: "https://github.com/AdonisCr/Docker-Exam",
    },
    {
      title: "GESTION-de-STOCK-API",
      description: "API RESTful pour la gestion de stocks avec endpoints CRUD complets.",
      image: "https://images.pexels.com/photos/1264210/pexels-photo-1264210.jpeg?auto=compress&cs=tinysrgb&w=800",
      technologies: ["HTML", "API REST", "JavaScript"],
      category: "web",
      demoUrl: "#",
      githubUrl: "https://github.com/AdonisCr/GESTION-de-STOCK-API",
    },
    {
      title: "Adonis_flutter",
      description: "Application mobile cross-platform développée avec Flutter.",
      image: "https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=800",
      technologies: ["Flutter", "Dart", "C++"],
      category: "mobile",
      demoUrl: "#",
      githubUrl: "https://github.com/AdonisCr/Adonis_flutter",
    },
  ];
